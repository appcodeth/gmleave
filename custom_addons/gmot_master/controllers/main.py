...
class MainController(http.Controller):
    ...
    @http.route('/gmot/', type='http', auth='user', website=True)
    ...
    @http.route('/gmot/salary/', type='http', auth='user', website=True)
    ...
    @http.route('/gmot/report/', type='http', auth='user', website=True)
    ...
    @http.route('/gmot/report/detail/', type='http', auth='user', website=True)
    ...
    @http.route('/gmot/config/', type='http', auth='user', website=True)
    ...
    @http.route('/gmot/ot/open/', type='http', auth='user', website=True)
    ...
    @http.route('/gmot/ot/jobs/', type='http', auth='user', website=True)
    ...
    @http.route('/gmot/ot/approve/', type='http', auth='user', website=True)
    ...
    @http.route('/gmot/ot/approve/draft/', type='http', auth='user', website=True)
    ...
    @http.route('/gmot/ot/approve/history/', type='http', auth='user', website=True)
