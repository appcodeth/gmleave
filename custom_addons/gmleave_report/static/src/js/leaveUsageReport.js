...
$('#btnRenderPDF').on('click', function() {
    ...
    window.open('http://157.230.255.67:8080/birt/run?__report=leave_usage.rptdesign&__format=pdf&year=' + year, '_blank');
});
...
$('#btnRenderExcel').on('click', function() {
    ...
    window.open('http://157.230.255.67:8080/birt/run?__report=leave_usage.rptdesign&__format=xlsx&year=' + year, '_blank');
});
