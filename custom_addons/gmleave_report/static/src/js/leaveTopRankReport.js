...
function runReport() {
    ...
    var tr = '';
    $.ajax({
        url: '/api/report/leave/toprank?start_date=' + start_date + '&end_date=' + end_date,
        type: 'get',
        async: false,
        success: function (res) {
            ...
            col_name += '<th class="text-center">จำนวนวันลา (วัน)</th>';
            ...
            $.each(res.rows, function (index, data) {
                ...
                col_value += '<td class="text-center">' + (data.total_day) + '</td>';
                tr += '<tr>' + col_value + '</tr>';
            });
